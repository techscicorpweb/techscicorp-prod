    ...
    <main>
      ...
      <section className="pt-4 pb-12 bg-white">
        <div className="container mx-auto px-6 max-w-4xl flex flex-col items-center text-center">
          ...
          <p className="text-sm text-slate-500 italic mt-3 max-w-2xl">
           Technology Science Corporation (TSC) is proud to be an Equal Opportunity Employer. Personnel decisions are made without regard to race, color, religion, creed, sex, sexual orientation, marital status, national origin, age, veteran status, disability, or any other protected class. All personnel decisions are based on position requirements, candidate qualifications and customer needs.
          </p>
        </div>
      </section>
